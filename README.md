...
The SWOT data to calibrate (the inputs: **ssh_with_error**) and their equivalent error-free SWOT data for evaluation (the targets: **ssh_without_error**) are hosted and available for download on the MEOM opendap server: see **Download the data** section below.
